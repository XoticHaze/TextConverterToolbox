...
from research import mnq_expected_move_forward_2026 as base
...
def main() -> int:
    # Keep the frozen expected-move hypothesis unchanged; replace only the
    # previously incorrect deep-source timestamp parser.
